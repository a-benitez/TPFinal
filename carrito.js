...
//Funcion para borrar productos totales del HTML simulando una compra exitosa 
    function comprarProducto(){
        Array.from(document.getElementsByClassName('producto-agregado')).forEach(producto => {
            producto.remove()
            console.log("¡Felicitaciones por tu compra!") //Para verificar que la simulación de compra funciona
        })
        totalFinal()
    }
